...
const SortTours = (props) => {
  const { date, dropdown } = props;
  ...
  return (
    <div
      className=" set_tours "
      style={{
        height: !dropdown ? "120px" : "180px",
      }}
    >
      <Container
        style={{
          justifyContent: !dropdown ? "center" : "space-between",
        }}
      >
        <div
          className="_header"
          ...
          <>
            ...
            <div className="sort_tours mobile">
              ...
              <div
                className={
                  isDropdow
                    ? "flex sort_swap mobile show"
                    : "flex sort_swap mobile"
                }
              >
                <div className="_header">
                  <div className="_margin_horizontal_sm ">
